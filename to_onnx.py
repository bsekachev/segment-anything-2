...
masks, low_res_masks, xtl, ytl, xbr, ybr = sam2_decoder(image_embed, high_res_feats_0, high_res_feats_1, point_coords, point_labels, orig_im_size, mask_input, has_mask_input)
...
torch.onnx.export(sam2_decoder,
                  (image_embed, high_res_feats_0, high_res_feats_1, point_coords, point_labels, orig_im_size, mask_input, has_mask_input),
                  f"{model_type}_decoder.onnx",
                  export_params=True,
                  opset_version=16,
                  do_constant_folding=True,
                  input_names = ['image_embeddings', 'high_res_feats_0', 'high_res_feats_1', 'point_coords', 'point_labels', 'orig_im_size', 'mask_input', 'has_mask_input'],
